...
import { Tractor, LogOut, Shield, FileCheck, Users, BarChart3, LayoutDashboard } from "lucide-react"
...
export function AdminNav() {
  ...
  const navItems = [
    { href: "/admin", label: "Panel Principal", icon: Shield },
    { href: "/admin/approvals", label: "Aprobaciones", icon: FileCheck },
    { href: "/admin/publications", label: "Publicaciones", icon: LayoutDashboard },
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          <Link href="/admin" className="flex items-center gap-2">
            ...
            <div>
              <span className="text-xl font-bold block">AgroLink</span>
